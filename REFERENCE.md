...
### 3. Hardcoded Login Bypass (Pengembangan Sementara)
> [!NOTE]
> **BYPASS PENGEMBANGAN SEMENTARA:** Untuk mempercepat testing/uji coba tanpa harus mengetik manual tiap kali aplikasi dijalankan:
> - **Username default**: `08123456789`
> - **Kata Sandi default**: `admin123`
> - **Lokasi Kode**: [`WelcomeScreen.kt`](file:///d:/Berau/kakao-android/app/src/main/java/com/beraucoal/kakao/ui/screens/WelcomeScreen.kt#L52-L54) (`var username by remember { mutableStateOf("08123456789") }` & `var password by remember { mutableStateOf("admin123") }`)
> - **Panduan Menghapus (Produksi)**: Cukup ganti nilai inisialisasi di `WelcomeScreen.kt` menjadi string kosong `""`.
